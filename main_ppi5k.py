...
def set_parser():
    ...
    parser.add_argument('--min_weight', type=float, default=0.7,help="邻居三元组的最小权重阈值。默认0.7")

    # 聚类相关参数
    parser.add_argument('--use_clustering', type=bool, default=True,help="是否使用聚类增强模块（簇共享embedding+门控融合+对比学习）")
    parser.add_argument('--num_entity_clusters', type=int, default=50,help="实体簇数量。推荐: CN15K=70, NL27K=130, PPI5K=50")
    parser.add_argument('--num_relation_clusters', type=int, default=3,help="关系簇数量。推荐: CN15K=10, NL27K=30, PPI5K=3")
